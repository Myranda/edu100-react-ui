...
const WebpackConfig = merge(BasicConfig, {
  ...
  entry: paths.appSrcEntrys,
  output: {
    // The build folder.
    path: paths.appBuild + '/' + env.raw.NODE_ENV,
    // Generated JS file names (with nested folders).
    // There will be one main bundle, and one file per asynchronous chunk.
    // We don't currently advertise code splitting but Webpack supports it.
    filename: SubDirectory + 'js/[name].[chunkhash:8].js',
    chunkFilename: SubDirectory + 'js/[name].[chunkhash:8].chunk.js',
    libraryTarget: 'umd',
  ...
  plugins: [
    ...
    new ExtractTextPlugin({
      filename: SubDirectory + 'css/[name].[contenthash:8].css',
      allChunks:true
    }),
    ...
    new SWPrecacheWebpackPlugin({
      ...
      navigateFallback: env.raw.PUBLIC_URL + '/index.html',
